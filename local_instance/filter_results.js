...
// filter_vulnerabilities('abc','84e6fb59b4de8f0dea291cf2c9eb9b431e782c88','c75c36c78e0a00870d7a19080cfc1283c0ae9b30',[
//  { "sourceid": "3",
...
console.log('------------------------------bef curr_hash');
console.log(cur_hash);
console.log(pre_hash);
	...
	Vulnerability.create({
				...
				if (type === 'installation_repositories')
					...
					for(element in vulnerabilities){
						...
						if (counter == vulnerabilities.length){
							resolve(obj);
						}
					}
			});
